...
OWNER_USERNAME = os.environ.get("OWNER_USERNAME", "MahanMVAdmin")

keyboard = [[
            InlineKeyboardButton('☠︎︎ 𝙼𝚢 𝙵𝚊𝚝𝚑𝚎𝚛 ☠︎︎', url=f"https://t.me/{OWNER_USERNAME}"),
            InlineKeyboardButton('☯︎ 𝙶𝚛𝚘𝚞𝚙 ☯︎', url="https://t.me/Rex_Bots_Support")
        ]]
...
def go_heck_verification(update, context):
    """ just for putting dust insid in
    their eyes 🤪🤣🤣 """
